...
public class ContactsServicePlugin implements MethodCallHandler {
    ...
    ContactsServicePlugin(Context context, ContentResolver contentResolver) {
    ...
    public static void registerWith(Registrar registrar) {
        ...
        channel.setMethodCallHandler(new ContactsServicePlugin(registrar.context(), registrar.context().getContentResolver()));
    }
    ...
    private static final String[] PROJECTION =
            {
                    ...
                    CommonDataKinds.Note.NOTE,Phone.NUMBER,
                    Phone.TYPE,
                    Phone.LABEL,
                    Email.DATA,
                    Email.ADDRESS,
...
private boolean withThumbnails;
    private boolean photoHighResolution;
        GetContactsTask(Result result, boolean withThumbnails, boolean photoHighResolution) {
      ...
      if (withThumbnails) {      for (Contact c : contacts) {
